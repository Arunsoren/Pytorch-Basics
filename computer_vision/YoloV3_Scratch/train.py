...
def train_fn(train_loader, model, optimzer, loss_fn, scaler, scaled_anchors):
...
def main():
    ...
    for epoch in range(config.NUM_EPOCHS):
        ...
        if epoch %10 == 0 and epoch >0:
            ...
            pred_boxes, true_boxes = get_evaluation_bboxes(   #Evaluation Boxes
                test_loader,
                model,
